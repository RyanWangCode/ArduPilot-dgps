...
//    warnx("%d %d %d",assume_zero_sideslip(),_ahrs->get_gps().status(),AP_GPS::GPS_OK_FIX_3D);
...
//    const float R_TAS = sq(constrain_float(_easNoise, 0.5f, 5.0f) * constrain_float(EAS2TAS, 0.9f, 10.0f));
    const float Rgyaw = 0.0076f; // assume RMS ~ 5
    Vector3f SHgyaw;
    Vector5 SKgyaw;
    Vector22 Hgyaw;
    Vector3f euler;
    ...
    {
        // calculate observation jacobians
    	SHgyaw[0] = 2*sq(q2) + 2*sq(q3) - 1;
    	SHgyaw[1] = 1/(sq(2*q0*q3 + 2*q1*q2) + sq(SHgyaw[0]));
    	SHgyaw[2] = 2*q0*q3 + 2*q1*q2;
        for (uint8_t i=0; i<=21; i++) Hgyaw[i] = 0.0f;
        Hgyaw[0] = -2*q3*SHgyaw[0]*SHgyaw[1];
        Hgyaw[1] = -2*q2*SHgyaw[0]*SHgyaw[1];
        Hgyaw[2] = -sq(SHgyaw[0])*SHgyaw[1]*((2*q1)/SHgyaw[0] - (4*q2*SHgyaw[2])/sq(SHgyaw[0]));
        Hgyaw[3] = -sq(SHgyaw[0])*SHgyaw[1]*((2*q0)/SHgyaw[0] - (4*q3*SHgyaw[2])/sq(SHgyaw[0]));

        // calculate Kalman gains
        float temp = (Rgyaw + 2*q3*SHgyaw[0]*SHgyaw[1]*(P[2][0]*sq(SHgyaw[0])*SHgyaw[1]*((2*q1)/SHgyaw[0] - (4*q2*SHgyaw[2])/sq(SHgyaw[0])) + P[3][0]*sq(SHgyaw[0])*SHgyaw[1]*((2*q0)/SHgyaw[0] - (4*q3*SHgyaw[2])/sq(SHgyaw[0])) + 2*P[0][0]*q3*SHgyaw[0]*SHgyaw[1] + 2*P[1][0]*q2*SHgyaw[0]*SHgyaw[1]) + 2*q2*SHgyaw[0]*SHgyaw[1]*(P[2][1]*sq(SHgyaw[0])*SHgyaw[1]*((2*q1)/SHgyaw[0] - (4*q2*SHgyaw[2])/sq(SHgyaw[0])) + P[3][1]*sq(SHgyaw[0])*SHgyaw[1]*((2*q0)/SHgyaw[0] - (4*q3*SHgyaw[2])/sq(SHgyaw[0])) + 2*P[0][1]*q3*SHgyaw[0]*SHgyaw[1] + 2*P[1][1]*q2*SHgyaw[0]*SHgyaw[1]) + sq(SHgyaw[0])*SHgyaw[1]*((2*q1)/SHgyaw[0] - (4*q2*SHgyaw[2])/sq(SHgyaw[0]))*(P[2][2]*sq(SHgyaw[0])*SHgyaw[1]*((2*q1)/SHgyaw[0] - (4*q2*SHgyaw[2])/sq(SHgyaw[0])) + P[3][2]*sq(SHgyaw[0])*SHgyaw[1]*((2*q0)/SHgyaw[0] - (4*q3*SHgyaw[2])/sq(SHgyaw[0])) + 2*P[0][2]*q3*SHgyaw[0]*SHgyaw[1] + 2*P[1][2]*q2*SHgyaw[0]*SHgyaw[1]) + sq(SHgyaw[0])*SHgyaw[1]*((2*q0)/SHgyaw[0] - (4*q3*SHgyaw[2])/sq(SHgyaw[0]))*(P[2][3]*sq(SHgyaw[0])*SHgyaw[1]*((2*q1)/SHgyaw[0] - (4*q2*SHgyaw[2])/sq(SHgyaw[0])) + P[3][3]*sq(SHgyaw[0])*SHgyaw[1]*((2*q0)/SHgyaw[0] - (4*q3*SHgyaw[2])/sq(SHgyaw[0])) + 2*P[0][3]*q3*SHgyaw[0]*SHgyaw[1] + 2*P[1][3]*q2*SHgyaw[0]*SHgyaw[1]));
        if (temp >= Rgyaw) {
            SKgyaw[0] = 1.0f / temp;
            SKgyaw[1] = (2*q0)/SHgyaw[0] - (4*q3*SHgyaw[2])/sq(SHgyaw[0]);
            SKgyaw[2] = (2*q1)/SHgyaw[0] - (4*q2*SHgyaw[2])/sq(SHgyaw[0]);
            SKgyaw[3] = sq(SHgyaw[0]);
            SKgyaw[4] = SHgyaw[1];
...
//            P[15][15] += 0.05f*R_TAS;
        ...
        Kfusion[0] = -SKgyaw[0]*(P[0][2]*SKgyaw[2]*SKgyaw[3]*SKgyaw[4] + P[0][3]*SKgyaw[1]*SKgyaw[3]*SKgyaw[4] + 2*P[0][0]*q3*SHgyaw[0]*SKgyaw[4] + 2*P[0][1]*q2*SHgyaw[0]*SKgyaw[4]);
        Kfusion[1] = -SKgyaw[0]*(P[1][2]*SKgyaw[2]*SKgyaw[3]*SKgyaw[4] + P[1][3]*SKgyaw[1]*SKgyaw[3]*SKgyaw[4] + 2*P[1][0]*q3*SHgyaw[0]*SKgyaw[4] + 2*P[1][1]*q2*SHgyaw[0]*SKgyaw[4]);
        Kfusion[2] = -SKgyaw[0]*(P[2][2]*SKgyaw[2]*SKgyaw[3]*SKgyaw[4] + P[2][3]*SKgyaw[1]*SKgyaw[3]*SKgyaw[4] + 2*P[2][0]*q3*SHgyaw[0]*SKgyaw[4] + 2*P[2][1]*q2*SHgyaw[0]*SKgyaw[4]);
        Kfusion[3] = -SKgyaw[0]*(P[3][2]*SKgyaw[2]*SKgyaw[3]*SKgyaw[4] + P[3][3]*SKgyaw[1]*SKgyaw[3]*SKgyaw[4] + 2*P[3][0]*q3*SHgyaw[0]*SKgyaw[4] + 2*P[3][1]*q2*SHgyaw[0]*SKgyaw[4]);
        Kfusion[4] = -SKgyaw[0]*(P[4][2]*SKgyaw[2]*SKgyaw[3]*SKgyaw[4] + P[4][3]*SKgyaw[1]*SKgyaw[3]*SKgyaw[4] + 2*P[4][0]*q3*SHgyaw[0]*SKgyaw[4] + 2*P[4][1]*q2*SHgyaw[0]*SKgyaw[4]);
        Kfusion[5] = -SKgyaw[0]*(P[5][2]*SKgyaw[2]*SKgyaw[3]*SKgyaw[4] + P[5][3]*SKgyaw[1]*SKgyaw[3]*SKgyaw[4] + 2*P[5][0]*q3*SHgyaw[0]*SKgyaw[4] + 2*P[5][1]*q2*SHgyaw[0]*SKgyaw[4]);
        Kfusion[6] = -SKgyaw[0]*(P[6][2]*SKgyaw[2]*SKgyaw[3]*SKgyaw[4] + P[6][3]*SKgyaw[1]*SKgyaw[3]*SKgyaw[4] + 2*P[6][0]*q3*SHgyaw[0]*SKgyaw[4] + 2*P[6][1]*q2*SHgyaw[0]*SKgyaw[4]);
        Kfusion[7] = -SKgyaw[0]*(P[7][2]*SKgyaw[2]*SKgyaw[3]*SKgyaw[4] + P[7][3]*SKgyaw[1]*SKgyaw[3]*SKgyaw[4] + 2*P[7][0]*q3*SHgyaw[0]*SKgyaw[4] + 2*P[7][1]*q2*SHgyaw[0]*SKgyaw[4]);
        Kfusion[8] = -SKgyaw[0]*(P[8][2]*SKgyaw[2]*SKgyaw[3]*SKgyaw[4] + P[8][3]*SKgyaw[1]*SKgyaw[3]*SKgyaw[4] + 2*P[8][0]*q3*SHgyaw[0]*SKgyaw[4] + 2*P[8][1]*q2*SHgyaw[0]*SKgyaw[4]);
        Kfusion[9] = -SKgyaw[0]*(P[9][2]*SKgyaw[2]*SKgyaw[3]*SKgyaw[4] + P[9][3]*SKgyaw[1]*SKgyaw[3]*SKgyaw[4] + 2*P[9][0]*q3*SHgyaw[0]*SKgyaw[4] + 2*P[9][1]*q2*SHgyaw[0]*SKgyaw[4]);
        Kfusion[10] = -SKgyaw[0]*(P[10][2]*SKgyaw[2]*SKgyaw[3]*SKgyaw[4] + P[10][3]*SKgyaw[1]*SKgyaw[3]*SKgyaw[4] + 2*P[10][0]*q3*SHgyaw[0]*SKgyaw[4] + 2*P[10][1]*q2*SHgyaw[0]*SKgyaw[4]);
        Kfusion[11] = -SKgyaw[0]*(P[11][2]*SKgyaw[2]*SKgyaw[3]*SKgyaw[4] + P[11][3]*SKgyaw[1]*SKgyaw[3]*SKgyaw[4] + 2*P[11][0]*q3*SHgyaw[0]*SKgyaw[4] + 2*P[11][1]*q2*SHgyaw[0]*SKgyaw[4]);
        Kfusion[12] = -SKgyaw[0]*(P[12][2]*SKgyaw[2]*SKgyaw[3]*SKgyaw[4] + P[12][3]*SKgyaw[1]*SKgyaw[3]*SKgyaw[4] + 2*P[12][0]*q3*SHgyaw[0]*SKgyaw[4] + 2*P[12][1]*q2*SHgyaw[0]*SKgyaw[4]);
        Kfusion[13] = -SKgyaw[0]*(P[13][2]*SKgyaw[2]*SKgyaw[3]*SKgyaw[4] + P[13][3]*SKgyaw[1]*SKgyaw[3]*SKgyaw[4] + 2*P[13][0]*q3*SHgyaw[0]*SKgyaw[4] + 2*P[13][1]*q2*SHgyaw[0]*SKgyaw[4]);
        Kfusion[14] = -SKgyaw[0]*(P[14][2]*SKgyaw[2]*SKgyaw[3]*SKgyaw[4] + P[14][3]*SKgyaw[1]*SKgyaw[3]*SKgyaw[4] + 2*P[14][0]*q3*SHgyaw[0]*SKgyaw[4] + 2*P[14][1]*q2*SHgyaw[0]*SKgyaw[4]);
        Kfusion[15] = -SKgyaw[0]*(P[15][2]*SKgyaw[2]*SKgyaw[3]*SKgyaw[4] + P[15][3]*SKgyaw[1]*SKgyaw[3]*SKgyaw[4] + 2*P[15][0]*q3*SHgyaw[0]*SKgyaw[4] + 2*P[15][1]*q2*SHgyaw[0]*SKgyaw[4]);
        // zero Kalman gains to inhibit magnetic field state estimation
        if (!inhibitMagStates) {
        	Kfusion[16] = -SKgyaw[0]*(P[16][2]*SKgyaw[2]*SKgyaw[3]*SKgyaw[4] + P[16][3]*SKgyaw[1]*SKgyaw[3]*SKgyaw[4] + 2*P[16][0]*q3*SHgyaw[0]*SKgyaw[4] + 2*P[16][1]*q2*SHgyaw[0]*SKgyaw[4]);
        	Kfusion[17] = -SKgyaw[0]*(P[17][2]*SKgyaw[2]*SKgyaw[3]*SKgyaw[4] + P[17][3]*SKgyaw[1]*SKgyaw[3]*SKgyaw[4] + 2*P[17][0]*q3*SHgyaw[0]*SKgyaw[4] + 2*P[17][1]*q2*SHgyaw[0]*SKgyaw[4]);
        	Kfusion[18] = -SKgyaw[0]*(P[18][2]*SKgyaw[2]*SKgyaw[3]*SKgyaw[4] + P[18][3]*SKgyaw[1]*SKgyaw[3]*SKgyaw[4] + 2*P[18][0]*q3*SHgyaw[0]*SKgyaw[4] + 2*P[18][1]*q2*SHgyaw[0]*SKgyaw[4]);
        	Kfusion[19] = -SKgyaw[0]*(P[19][2]*SKgyaw[2]*SKgyaw[3]*SKgyaw[4] + P[19][3]*SKgyaw[1]*SKgyaw[3]*SKgyaw[4] + 2*P[19][0]*q3*SHgyaw[0]*SKgyaw[4] + 2*P[19][1]*q2*SHgyaw[0]*SKgyaw[4]);
        	Kfusion[20] = -SKgyaw[0]*(P[20][2]*SKgyaw[2]*SKgyaw[3]*SKgyaw[4] + P[20][3]*SKgyaw[1]*SKgyaw[3]*SKgyaw[4] + 2*P[20][0]*q3*SHgyaw[0]*SKgyaw[4] + 2*P[20][1]*q2*SHgyaw[0]*SKgyaw[4]);
        	Kfusion[21] = -SKgyaw[0]*(P[21][2]*SKgyaw[2]*SKgyaw[3]*SKgyaw[4] + P[21][3]*SKgyaw[1]*SKgyaw[3]*SKgyaw[4] + 2*P[21][0]*q3*SHgyaw[0]*SKgyaw[4] + 2*P[21][1]*q2*SHgyaw[0]*SKgyaw[4]);
        } else {
            for (uint8_t i=16; i<=21; i++) {
                Kfusion[i] = 0.0f;
            }
...
//        varInnovVtas = 1.0f/SK_TAS;
        ...
        innovVtas = euler.z - 0.785f; //gpsyaw
...
//        tasTimeout = (imuSampleTime_ms - lastTasPassTime) > tasRetryTime;
        ...
        if (tasHealth || (tasTimeout && posTimeout))
        {
            ...
            for (uint8_t i = 0; i<=21; i++)
            {
                for (uint8_t j = 0; j<=3; j++) KH[i][j] = Kfusion[i] * Hgyaw[j];
                for (uint8_t j = 4; j<=21; j++)
                {
                	KH[i][j] = 0.0f;
                }
            }
...
void NavEKF::readGpsData()
{
            ...
            (_ahrs->get_gps().status() >= AP_GPS::GPS_OK_FIX_3D))
    {
        ...
        // gpsalt0=gpsalt;
        float dtgps=(float)lastFixTime_ms-(float)secondLastFixTime_ms;
        if(secondLastFixTime_ms>100 && dtgps>1)
        {
			gpsalt=gpsalt-0.5f*(velNED.z+oldvz)*dtgps/1000;
			if(!vehicleArmed)
			{
				gpsaltoff=gpsalt-hgtMea;
			}
        }
        // hal.console->printf("dt:%.4f %.4f %.4f %.4f %d %d %.4f\n",velNED.z,gpsalt0,gpsalt,(double)gpsaltoff,lastFixTime_ms,secondLastFixTime_ms,dtgps);
...
{
// 	if(vehicleArmed && newDataGpsH)
// 	{
// 		newDataGpsH=false;
// 		hgtMea = gpsalt-gpsaltoff;
...
// //		hal.console->printf("gpshgt:%.4f %.4f %.4f %.4f %.4f\n",(double)(gpsalt),(double)hgtMea,(double)gpsaltoff,statesAtHgtTime.position.z,statesAtHgtTime.position[2]);
// 	}
...
void  NavEKF::getInnovations(Vector3f &velInnov, Vector3f &posInnov, Vector3f &magInnov, float &tasInnov, float &galt) const
{
